...
eCameraShakeShake=setmetatable({
    ["CameraShakeShakeHand"] = 0,
	["CameraShakeShakeSmallExplosion"] = 1,
	["CameraShakeShakeMediumExplosion"]= 2,
	["CameraShakeShakeLargeExplosion"]=3,
	["CameraShakeShakeJolt"]=4,
	["CameraShakeShakeVibrate"]=5,
	["CameraShakeShakeRoadVibration"]=6,
	["CameraShakeShakeDrunk"]=7,
	["CameraShakeShakeSkyDiving"]=8,
	["CameraShakeShakeFamilyDrugTrip"]=9,
	["CameraShakeShakeDeathFail"]=10,
},metatable)


eControl=setmetatable({
    ["ControlNextCamera"]= 0,
...
eRadioStation =setmetatable({
    ["RadioStationLosSantosRockRadio"]=1,
	["RadioStationNonStopPopFM"]=2,
	["RadioStationLosSantos"]=3,
	["RadioStationChannelX"]=4,
	["RadioStationWestCoastTalkRadio"]=5,
	["RadioStationRebelRadio"]=6,
	["RadioStationSoulwaxFM"]=7,
	["RadioStationEastLosFM"]=8,
	["RadioStationWestCoastClassics"]=9,
	["RadioStationTheBlueArk"]=10,
	["RadioStationWorldWideFM"]=11,
	["RadioStationFlyloFM"]=12,
	["RadioStationTheLowdown"]=13,
	["RadioStationTheLab"]=14,
	["RadioStationMirrorPark"]=15,
	["RadioStationSpace"]=16,
	["RadioStationVinewoodBoulevardRadio"]=17,
},metatable)

eWindowTitle=setmetatable({
    ["CELL_EMAIL_BOD"]=1,
	["CELL_EMAIL_BODE"]=2,
	["CELL_EMAIL_BODF"]=3,
	["CELL_EMAIL_SOD"]=4,
...
eGender=setmetatable({
    ["GenderMale"] = 1,
    ["GenderFemale"] = 2,
},metatable)

eDrivingStyle=setmetatable({
...
eVehicleLockStatus =setmetatable({
...
eVehicleLandingGear = setmetatable({
...
eVehicleMod = setmetatable({
	...
	["VehicleModBackWheels"]= 24 -- only for motorcycles
},metatable)

eVehicleNeonLight=setmetatable({
...
eVehicleRoofState=setmetatable({
...
eVehicleWindow=setmetatable({
	["VehicleWindowFrontRightWindow"]= 1,
	["VehicleWindowFrontLeftWindow"]= 0,
	["VehicleWindowBackRightWindow"]= 3,
	["VehicleWindowBackLeftWindow"]= 2,
},metatable)

eVehicleWindowTint=setmetatable({
...
eNumberPlateMounting=setmetatable({
...
eRopeType=setmetatable({
	["RopeTypeNormal"]=4,
},metatable)

eWeapon = setmetatable({
